...
plot_ly() %>%
  add_trace(
    ...
    line = list(color = INFERNO$lineA, width = 3)
  ) %>%
  add_trace(
    x = x,
    y = y_multi,
    ...
    line = list(color = INFERNO$lineB, width = 3)
  ) %>%
  ...
  add_trace(
    ...
    type = 'scatter',
    mode = 'markers+text',
    marker = list(size = 12, color = INFERNO$annotation, symbol = 'x'),
    text = "Initial",
    textposition = 'bottom right',
    textfont = list(size = 14, color = INFERNO$annotation),
    showlegend = FALSE,
    hoverinfo = 'skip'
  ) %>%
  ...
  layout(
    ...
    shapes = list(
      ...
      list(
        ...
        y0 = end_energy,
        y1 = end_energy,
        line = list(color = INFERNO$annotation, width = 1, dash = "dash")
      )
    ),
    plot_bgcolor = 'white',
    paper_bgcolor = 'white',
