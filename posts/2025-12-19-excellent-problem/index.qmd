...
plot_ly() %>%
  ...
  add_trace(
    ...
    mode = "markers",
    x = 0.35, y = 0.4,
    name = "high quality data available",
    marker = list(size = 220, color = "rgba(255,165,0,0.2)", line = list(color = "darkorange", width = 2)),
    showlegend = TRUE
  ) %>%
  # Circle 2 - important
  add_trace(
    ...
    x = 0.65, y = 0.44,
    name = "important",
    marker = list(size = 320, color = "rgba(128,0,128,0.2)", line = list(color = "purple", width = 2)),
    showlegend = TRUE
  ) %>%
  ...
  add_trace(
    ...
    x = 0.5, y = 0.6,
    name = "combinatorial",
    marker = list(size = 260, color = "rgba(144,238,144,0.2)", line = list(color = "green", width = 2)),
    showlegend = TRUE
  ) %>%
  layout(
    autosize = TRUE,
